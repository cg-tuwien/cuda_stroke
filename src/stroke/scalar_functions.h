...
template <typename scalar_t>
inline __host__ scalar_t max(scalar_t a, scalar_t b)
{
    return std::max(a, b);
}

template <typename scalar_t>
inline __host__ scalar_t min(scalar_t a, scalar_t b)
{
    return std::min(a, b);
}

template <typename scalar_t>
inline __host__ scalar_t exp(scalar_t x)
{
    return std::exp(x);
}

template <typename scalar_t>
inline __host__ scalar_t pow(scalar_t x, scalar_t y)
{
    return std::pow(x, y);
}

template <typename scalar_t>
inline __host__ scalar_t log(scalar_t x)
{
    return std::log(x);
}

template <typename scalar_t>
inline __host__ scalar_t sqrt(scalar_t x)
{
    return std::sqrt(x);
}

template <typename scalar_t>
inline __host__ scalar_t abs(scalar_t x)
{
    return std::abs(x);
}

template <typename scalar_t>
inline __host__ scalar_t acos(scalar_t x)
{
    return std::acos(x);
}

template <typename scalar_t>
inline __host__ scalar_t cos(scalar_t x)
{
    return std::cos(x);
}
...
template <typename T,
    std::enable_if_t<std::is_floating_point<T>::value, bool> = true>
__host__ inline bool isnan(T x)
{
    return std::isnan(x);
}

template <typename scalar_t>
inline __host__ scalar_t erf(scalar_t x)
{
    return std::erf(x);
}
